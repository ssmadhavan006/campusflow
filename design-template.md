...
| `{typography.display-lg}` | 40px | 600 | 1.10 | -0.3px | Tile headlines atop every product tile |
...
- **Weight 600, not 700, for headlines.** Apple's headlines sit at weight 600, including `{typography.tagline}` (21px) — there is no 700 in this system.
...
- **Weight 500 is deliberately absent.** The ladder is 300 / 400 / 600. Mid-weight readings always use 600.
